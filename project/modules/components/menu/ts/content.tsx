...
export const SideMenuContent = ({ title }): JSX.Element => {
	...
	const cls: string = isOpen ? 'side-menu__content' : 'side-menu__content__hide side-menu__content';
	...
	return (
		<>
			<div className={cls}>
				<IconButton icon='close' className='side-menu__toggle' onClick={toggleMenu} />
